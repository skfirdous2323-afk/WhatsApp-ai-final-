      ...
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-2xl shadow-lg">
        ...
        <div className="space-y-6 text-gray-700">
          <section>
            ...
            <p>
              By using our services, you agree to these Terms & Conditions. If
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li>Do not misuse the booking system</li>
          ...
          <section>
            ...
            <p>
              Cancellation and refund eligibility will be handled according to
              the applicable cancellation and refund policies.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We are not responsible for delays, interruptions, or issues caused
          ...
          <section>
            ...
            <p>
              ...
              contact us through the available support channels.
            </p>
          </section>
        </div>
      </div>
