...
export default function WorkingHoursPage() {
  ...
  // ✅ Appointment settings matching migration exactly
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">Step 4 of 6 – Working Hours & Settings</p>
          </div>
          <button
            onClick={handleSave}
            disabled={saving}
            className="rounded-lg bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-2.5 font-semibold text-white hover:from-blue-700 hover:to-blue-800 transition-all shadow-md hover:shadow-lg disabled:opacity-50"
          >
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <div className="rounded-xl bg-white p-6 shadow-xl border border-gray-100">
              <h2 className="mb-6 text-xl font-semibold text-gray-900">Weekly Schedule</h2>
          ...
          <div className="lg:col-span-1">
            {/* ✅ Appointment Settings - Migration compatible */}
            <div className="rounded-xl bg-white p-6 shadow-xl border border-gray-100">
              <h2 className="mb-6 text-xl font-semibold text-gray-900">⚙️ Appointment Settings</h2>
              <div className="space-y-4">
                <div>
